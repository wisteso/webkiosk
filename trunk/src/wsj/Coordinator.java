...
public class Coordinator
{
	...
	static
    {
		...
		timestamp = new SimpleDateFormat(String.format("%s '%s'", 
				getString("http.date"), getString("config.GMT")), java.util.Locale.US);
    ...
    {
		// TODO: Change listen and server threads to not auto start. Start here instead.
    }
    ...
    public void sendGetRequest(HttpRequest request, OutputStream out) throws IOException
    {
		...
		try
		{
			// TODO: fix issue with null returns from open resource and inBody.available
